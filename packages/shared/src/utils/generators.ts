 ...
 */
export function generateIndianName(seed?: number): { firstName: string; lastName: string; gender: 'male' | 'female' } {
 ...
 */
export function generateRollNumber(classNum: number, section: string, studentNum: number): string {
 ...
 */
export function generateSchoolTimestamp(daysAgo: number = 0, seed?: number): Date {
    const rng = new SeededRandom(seed);
 ...
 * Mean: 65, Std Dev: 15
 */
export function generateRealisticScore(maxScore: number = 100, seed?: number): number {
    const rng = new SeededRandom(seed);
 ...
 */
export function generateCompletionPercentage(daysSinceStart: number, seed?: number): number {
    const rng = new SeededRandom(seed);
 ...
 */
export function generateEmail(firstName: string, lastName: string, domain: string = 'student.vidyut.org'): string {
 ...
 */
export function generateAttendancePercentage(seed?: number): number {
    const rng = new SeededRandom(seed);
 ...
 */
export function generateDateRange(startDaysAgo: number, endDaysAgo: number): Date[] {
    const dates: Date[] = [];
 ...
 */
export function generateStudyStreak(seed?: number): number {
    const rng = new SeededRandom(seed);
 ...
 */
export function generatePoints(daysSinceJoin: number, seed?: number): number {
    const rng = new SeededRandom(seed);
